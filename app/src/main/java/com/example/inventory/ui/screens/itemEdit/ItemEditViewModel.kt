...
package com.example.inventory.ui.screens.itemEdit
...
import com.example.inventory.ui.screens.itemDetails.toItemUiState
...
class ItemEditViewModel(
    ...
    init {
        viewModelScope.launch {
            itemEntryUiState = itemsRepository.getItemStream(itemId)
                .filterNotNull()
                .first()
                .toItemUiState(true)
        }
    ...
    suspend fun updateItem() {
        if (validateInput(itemEntryUiState.itemDetails)) {
            itemsRepository.updateItem(itemEntryUiState.itemDetails.toItem())
        }
    }
